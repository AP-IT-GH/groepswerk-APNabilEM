...
namespace BoatAttack
{
    public class Engine : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="modifier">Acceleration modifier, adds force in the -1 to 1 range</param>
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawCube(enginePosition, new Vector3(0.1f, 0.2f, 0.3f)); // Draw the engine position with cube
        }
	}
}
